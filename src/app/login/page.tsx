    ...
    <div className='min-h-screen bg-gradient-to-br from-[#0B1426] via-[#1A2744] to-[#2D4A7A] flex'>
      ...
      <div className='hidden lg:flex lg:flex-1 flex-col justify-center items-center p-12 relative overflow-hidden'>
        ...
        <div className='absolute inset-0 opacity-10'>
          <div className='absolute top-20 left-20 w-32 h-32 border border-orange-400/30 rounded-full'></div>
          <div className='absolute bottom-40 right-16 w-24 h-24 border border-orange-400/20 rounded-full'></div>
          <div className='absolute top-1/2 left-1/4 w-16 h-16 border border-orange-400/25 rounded-full'></div>
        </div>
        ...
        <div className='relative z-10 text-center'>
          <div className='mb-8 relative'>
            ...
            <div className='absolute -inset-4 bg-gradient-to-r from-orange-400/20 to-transparent rounded-full blur-xl'></div>
          </div>
